...
import com.example.employeeexample.ui.login.LoginFragmentDirections
...
class ChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        send_message.setOnClickListener{
            ...
            if(messageText.isBlank()){
                Toast.makeText(requireContext(), getString(R.string.enter_message),
                ...
                ref.setValue(userMessage).addOnSuccessListener {
                    ...
                    .addOnFailureListener { ex : Exception ->
                        Toast.makeText(requireContext(),
                            getString(R.string.send_message_failure, ex.toString()) ,
    ...
    private fun setupMessageList(){
        ...
        val options: FirebaseRecyclerOptions<UserMessage> =
            ...
            .build()
        adapter =
            object : FirebaseRecyclerAdapter<UserMessage, ViewHolder?>(options) {
